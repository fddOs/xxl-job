...
import static com.xxl.job.executor.core.ProjectConstant.*;
...
public class CodeGenerator {
	...
	// "jdbc:sqlserver://192.168.1.79:1433;DatabaseName=Koala_dev";
	// private static final String JDBC_USERNAME = "Dev_YD";
	// private static final String JDBC_PASSWORD = "w=nIXOt)AU~COXOD#%!q";
	// private static final String JDBC_DIVER_CLASS_NAME =
	// "com.microsoft.sqlserver.jdbc.SQLServerDriver";
	//
	private static final String JDBC_URL = "jdbc:mysql://localhost:3306/nrl?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
	...
	public static void genModelAndMapper(String tableName, String modelName) {
		...
		// tableConfiguration.setGeneratedKey(new GeneratedKey("shopId",
		// "SqlServer", true, null));
	...
	public static void genController(String tableName, String modelName, String tableRemark) {
		try {
			...
			// cfg.getTemplate("controller.ftl").process(data, new
			// FileWriter(file));
